...
<title><?php echo str_replace('.','','B.u.R.N.2.0.1.0');?></title>
<style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head">
		<td><span style="float:right;"><a href="http://www." target="_blank"><?php echo str_replace('.','','B.U.R.N');?> Ver: 2010</a></span><?php echo $_SERVER['HTTP_HOST'];?> (<?php echo gethostbyname($_SERVER['SERVER_NAME']);?>)</td>
	</tr>
	<tr class="alt1">
